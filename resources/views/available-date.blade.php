        ...
        <div class="container border">                  
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <form action="{{ route('check.available.dates') }} " method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 p-0 m-0">
                                <div class="panel-heading  text-center mb-4 p-3">Check Available Date</div>
                             </div>
                             <div class="col-md-6">
                             ...
                             <div class="col-md-3">
                                ...
                                <label>Select Year</label>
                                     <select class="form-control" name="selectedYear" id="selectedMonth">
